...
get_header();
$services_meta = ! empty( constructo_meta( 'service_accordions') ) ? constructo_meta( 'service_accordions') : '';
$service_faqs = ! empty( constructo_meta( 'service_faqs') ) ? constructo_meta( 'service_faqs') : '';
$brochure = ! empty( constructo_meta( 'brochure') ) ? constructo_meta( 'brochure') : '';
$download_icon = CONSTRUCTO_DIR_ICON_IMG_URI . 'download.svg';
$count = 0;
if( have_posts() ) {
                                    ...
                                    <div class="service_thumb">
                                        <?php
                                            if( $single_item['image_id'] ) {
                                                echo wp_get_attachment_image( $single_item['image_id'], 'constructo_service_details_thumb_754x410', '', array('alt' => get_the_title() ) );
                                            }
                                        ?>
                                    </div>
                                </div>
