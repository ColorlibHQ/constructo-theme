...
// image default alt
if ( ! function_exists( 'constructo_img_default_alt' ) ) {
	function constructo_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'constructo_img_tag' ) ) {
	function constructo_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = constructo_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'constructo_anchor_tag' ) ) {
	function constructo_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'constructo_heading_tag' ) ) {
	function constructo_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'constructo_paragraph_tag' ) ) {
	function constructo_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'constructo_other_tag' ) ) {
	function constructo_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'constructo_button_element ' ) ) {
	function constructo_button_element( array $args ) {
