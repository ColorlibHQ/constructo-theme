...
function constructo_widgets_init() {
    // sidebar widgets register
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar', 'constructo' ),
        'id'            => 'constructo-post-sidebar',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer One', 'constructo' ),
        'id'            => 'footer-1',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Two', 'constructo' ),
        'id'            => 'footer-2',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Three', 'constructo' ),
        'id'            => 'footer-3',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Four', 'constructo' ),
        'id'            => 'footer-4',
...
add_action( 'widgets_init', 'constructo_widgets_init' );
