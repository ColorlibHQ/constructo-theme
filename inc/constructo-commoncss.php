...
// enqueue css
function constructo_common_custom_css(){
    
    wp_enqueue_style( 'constructo-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= constructo_opt( 'constructo_theme_color' ) != '#131313' ? constructo_opt( 'constructo_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= constructo_opt( 'constructo_book_btn_color' ) != '#131313' ? constructo_opt('constructo_book_btn_color') : '';
		$bookBtnHoverBgColor     	= constructo_opt( 'constructo_book_btn_hvr_bg_color' ) != '#131313' ? constructo_opt('constructo_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = constructo_opt( 'constructo_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = constructo_opt( 'constructo_navbar_bg_color' ) != '#082b49' ? constructo_opt( 'constructo_navbar_bg_color') : '';
		$headerTop_col     		  = constructo_opt( 'constructo_top_header_color' );

		$headerTopBg      		  = constructo_opt( 'constructo_top_header_bg_color');
		$headerBg          		  = constructo_opt( 'constructo_header_bg_color') != '#ffffff' ? constructo_opt( 'constructo_header_bg_color') : '';
		$menuColor          	  = constructo_opt( 'constructo_header_menu_color' ) != '#131313' ? constructo_opt('constructo_header_menu_color') : '';
		$menuHoverColor           = constructo_opt( 'constructo_header_menu_hover_color' ) != '#808080' ? constructo_opt('constructo_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = constructo_opt( 'constructo_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = constructo_opt( 'constructo_header_drop_menu_bg_color' ) != '#ffffff' ? constructo_opt('constructo_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = constructo_opt( 'constructo_dropdown_menu_color' ) != '#131313' ? constructo_opt('constructo_dropdown_menu_color') : '';
		$dropMenuHovColor         = constructo_opt( 'constructo_dropdown_menu_hover_color' ) != '#808080' ? constructo_opt('constructo_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = constructo_opt( 'constructo_footer_widget_bg_color' );
		$footerwHeadColor   	  = constructo_opt('constructo_footer_widget_heading_color');
		$footerwTextColor   	  = constructo_opt('constructo_footer_widget_text_color');
		$footerwanchorcolor 	  = constructo_opt('constructo_footer_widget_anchor_color') != '#ffffff' ? constructo_opt('constructo_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = constructo_opt('constructo_footer_widget_anchor_hover_color') != '#ffffff' ? constructo_opt('constructo_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = constructo_opt('constructo_fof_bg_color');
		$foftonecolor			  = constructo_opt('constructo_fof_textone_color');
		$fofttwocolor			  = constructo_opt('constructo_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = constructo_opt('constructo_footer_widget_anchor_color') != '#9e9e9e' ? constructo_opt('constructo_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .constructo_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .constructo_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'constructo-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'constructo_common_custom_css', 50 );